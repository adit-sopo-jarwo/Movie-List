    ...
    <div class="w-full h-screen">
        @php
            ...
            if (isset($movieData->genres)) {
                foreach ($movieData->genres as $item) {
                    $genre .= $item->name . ', ';
                }
                $genre = rtrim($genre, ', ');
            }
        ...
        {{-- similar movie --}}
        {{-- @include('MovieList/Movie-Similar') --}}
    </div>

    <!-- Trailer wrapper -->
    <div class="absolute top-0 right-0 m-4" id="trailerWrapper">
        <button class="group" onclick="showTrailer(false)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-x-square"
                viewBox="0 0 16 16">
                <path
        ...
        <iframe id="youtubeVideo" class="w-full h-full"
            ...
            frameborder="0" width="600px" height="400px"
